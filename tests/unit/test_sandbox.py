...
def check_code_safety(code):
    ...
    if hasattr(sandbox, 'validate_code'):
        ...
        return {
            ...
            'error': '; '.join(result.errors) if hasattr(result, 'errors') and result.errors else result.get('error')
        }
    else:
...
"""
    ...
    def test_timeout_handling(self):
        ...
        if hasattr(result, 'success'):
            ...
            self.assertTrue(
                ...
                "timeout" in result.get("output", "").lower() or
    ...
    def test_exception_handling(self):
        ...
        if hasattr(result, 'success'):
            ...
            self.assertTrue("error" in result.get("output", "").lower() or
                            "error" in result.get("error", "").lower() or
