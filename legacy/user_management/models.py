...
class UserQuota:
    ...
    def __init__(self, user_id: str,
        ...
        self.daily_tasks_limit = daily_tasks_limit if daily_tasks_limit is not None else self.DEFAULT_DAILY_LIMIT
        self.concurrent_tasks_limit = concurrent_tasks_limit if concurrent_tasks_limit is not None else self.DEFAULT_CONCURRENT_LIMIT
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "concurrent_tasks_limit": self.concurrent_tasks_limit if self.concurrent_tasks_limit > 0 else "无限制",
